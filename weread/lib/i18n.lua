...
local zh = {
    ...
    ["Sign out eink login? Bookshelf, download and progress will need login again."] = "退出墨水屏登录？书架、下载和进度需要重新扫码。",
    ...
    ["Scanning requires eink login to match folders against your WeRead shelf."] = "扫描需要先墨水屏登录，以便与书架匹配。",
