...
local zh = {
    ...
    ["Underlines and thoughts management"] = "划线与想法管理",
    ["Download thoughts for this chapter"] = "下载当前章节的想法",
    ["Could not determine the current chapter."] = "无法确定当前章节。",
    ["Underlines and thoughts"] = "划线与想法",
    ["Match local book with WeRead"] = "将本地书匹配到微信读书",
    ["Match with WeRead book"] = "匹配微信读书书目",
    ["Linked WeRead book: %1"] = "已关联微信读书：%1",
    ["Continue matching"] = "继续匹配",
    ["Continue matching · %1/%2 chapters, %3 underlines"] = "继续匹配 · %1/%2 章，%3 条划线",
    ["Choose chapters to match"] = "选择章节匹配",
    ["Clear underlines and thoughts"] = "清除划线与想法",
    ["Failed to clear underlines and thoughts: %1"] = "清除划线与想法失败：%1",
    ["Underlines and thoughts cleared. Match again to download fresh data."] = "划线与想法已清除。重新匹配可获取最新数据。",
    ["Annotation matching requires a reflowable document."] = "划线匹配需要可重排版文档（如 EPUB）。",
    ["Annotation progress saved."] = "划线进度已保存。",
    ["Annotation sync paused: %1\nSaved progress will be reused."] = "划线同步已暂停：%1\n已保存进度下次可继续使用。",
    ["Bind this book to WeRead to match underlines and thoughts?"] = "是否将本书关联至微信读书以匹配划线和想法？",
    ["Match selected chapters (%1)"] = "匹配所选章节（%1）",
    ["Match underlines and thoughts for “%1”?\nOnly chapters in this file are processed. Future prefetched chapters can prepare annotations automatically."] = "是否为《%1》匹配划线和想法？\n仅处理当前文件中的章节，后续预下载的章节会自动准备划线。",
    ["Matched"] = "已匹配",
    ["Matched %1/%2 underlines in %3/%4 chapters."] = "已在 %3/%4 章中匹配 %1/%2 条划线。",
    ["Matching underlines %1/%2 · chapter %3/%4"] = "正在匹配划线 %1/%2 · 章节 %3/%4",
    ["No chapter catalog available."] = "未获取到章节目录。",
    ["No matching chapters found."] = "未找到匹配章节。",
    ["No matching chapters found. Check the bound book and local chapter titles."] = "未找到匹配章节。请检查关联书籍与本地章节标题。",
    ["Start matching"] = "开始匹配",
    ["Preparing chapter %1/%2"] = "正在准备章节 %1/%2",
    ["Pause"] = "暂停",
    ["Pause at any time. Saved chapters and batches will be reused."] = "可随时暂停。已保存的章节和批次可继续使用。",
    ["Enable"] = "开启",
    ["Copy"] = "复制",
    ["Downloading"] = "正在下载",
    ["%1 · chapter %2/%3"] = "%1 · 章节 %2/%3",
    ["Downloading underlines and thoughts adds requests for every chapter and may significantly increase download time and cache usage. Continue?"] = "下载划线和想法会逐章增加网络请求，可能显著增加下载时间与缓存占用。是否继续？",
    ["Automatic prefetch runs in a background process and uses extra network and storage. Enable it?"] = "自动预下载将在后台运行并消耗额外的网络与存储。是否开启？",
    ["Background prefetch is unavailable"] = "后台预下载不可用",
    ["Background prefetch timed out"] = "后台预下载超时",
    ["Not enough free memory; prefetch skipped"] = "可用内存不足，已跳过预下载",
    ...
    ["Performance timing logs"] = "性能计时日志",
    ["Thought %1/%2"] = "想法 %1/%2",
    ["Previous"] = "上一页",
    ["Comment"] = "评论",
    ["Reply"] = "回复",
    ...
    ["Reply posted."] = "回复已发布。",
    ["Sign in to eink to comment."] = "评论需要先登录墨水屏。",
    ["Download this chapter's thoughts again to reply."] = "回复需要先重新下载本章想法。",
    ["Reply to %1"] = "回复 %1",
    ...
    ["Book images"] = "书籍图片",
    ["Chapter concurrency"] = "章节并发数",
    ["Chapter concurrency: %1"] = "章节并发数：%1",
    ...
    ["WeChat login (shelf / progress)"] = "微信登录（书架/进度）",
    ["WeChat login · %1"] = "微信登录 · %1",
    ["Eink login (fast download)"] = "墨水屏登录（整本快下）",
    ["Eink login (fast download / upload highlights)"] = "墨水屏登录（整本快下 / 上传划线）",
    ["Local highlights upload to WeRead while signed in"] = "已登录时，本地划线/想法会同步到微信",
    ["Eink login · %1"] = "墨水屏登录 · %1",
    ["signed in"] = "已登录",
    ["Scan again"] = "重新扫码",
    ["Renew eink login now"] = "立即续期墨水屏登录",
    ["Renew eink login"] = "续期墨水屏登录",
    ["Eink login renewed."] = "墨水屏登录已续期。",
    ["Eink login is missing."] = "还没有墨水屏登录。",
    ["Eink login could not be renewed. Scan the QR code again."] = "墨水屏登录续期失败，请重新扫码。",
    ["Sign out"] = "退出",
    ["Sign out WeChat"] = "退出微信登录",
    ["Sign out eink"] = "退出墨水屏登录",
    ["Clear all logins"] = "清除全部登录",
    ["Sign out WeChat login? Shelf and progress will need WeChat login again."] = "退出微信登录？书架和进度需要重新微信扫码。",
    ["Sign out eink login? Full-book fast download will fall back to web."] = "退出墨水屏登录？整本快下会退回网页逐章。",
    ["Sign out eink login? Full-book fast download will fall back to web. Local highlights will stop uploading."] = "退出墨水屏登录？整本快下会退回网页逐章，本地划线也不再上传。",
    ["Clear all WeRead logins? Cached books will remain."] = "清除全部登录？已缓存书籍会保留。",
    ["WeChat login signed out."] = "已退出微信登录。",
    ["Eink login signed out."] = "已退出墨水屏登录。",
    ["QR login"] = "扫码登录",
    ["Eink QR login"] = "墨水屏扫码登录",
    ["Eink QR login (replace)"] = "重新扫码墨水屏登录",
    ["Eink logged in · %1"] = "墨水屏已登录 · %1",
    ["Eink account"] = "墨水屏账号",
    ["Getting eink login QR code..."] = "正在获取墨水屏登录二维码……",
    ["Eink QR login cancelled."] = "墨水屏扫码登录已取消。",
    ["Eink QR login failed:\n%1"] = "墨水屏扫码登录失败：\n%1",
    ["The eink QR code has expired. Please try again."] = "墨水屏二维码已失效，请重新扫码。",
    ["Eink QR login was declined."] = "墨水屏扫码登录已拒绝。",
    ["Completing eink login..."] = "正在完成墨水屏登录……",
    ...
    ["OK"] = "好的",
    ["Thought popup settings"] = "想法弹窗设置",
    ["Thought popup position"] = "想法弹窗位置",
    ["Thought popup height"] = "想法弹窗高度",
    ["Thought popup width"] = "想法弹窗宽度",
    ["Thought popup font size"] = "想法弹窗字号",
    ["Thought popup font contrast"] = "想法弹窗对比度",
    ["Thought popup: tap left/right to turn pages"] = "想法弹窗：点左右翻页",
    ["Position: %1"] = "位置：%1",
    ["Height: %1%"] = "高度：%1%",
    ["Width: %1%"] = "宽度：%1%",
    ["Font size"] = "字号",
    ["Font contrast: Default"] = "字体对比度：默认",
    ["Font contrast: %1"] = "字体对比度：%1",
    ["Tap left/right to turn pages"] = "点按左右翻页",
    ["Center"] = "居中",
    ["Bottom"] = "底部",
    ["Set height"] = "设置高度",
    ["Set width"] = "设置宽度",
    ["Set font size"] = "设置字号",
    ["Set contrast"] = "设置对比度",
    ["Set a relative font size instead"] = "改为设置相对字号",
    ["Set an absolute font size instead"] = "改为设置绝对字号",
    ["Set the thought popup height as a percentage of the screen height (20%-90%)."] = "按屏幕高度的百分比设置想法弹窗高度（20%-90%）。",
    ["Set the centered thought popup width as a percentage of the screen width (40%-100%)."] = "按屏幕宽度的百分比设置居中想法弹窗宽度（40%-100%）。",
    ["The thought popup font adjusts to the font size you've set for the document, but you can specify here a fixed absolute font size to be used instead."] = "想法弹窗字号默认跟随正文，也可以在这里指定一个固定的绝对字号。",
    ["The thought popup font adjusts to the font size you've set for the document.\nYou can specify here how much smaller or larger it should be relative to the document font size.\nA negative value will make it smaller, while a positive one will make it larger.\nThe recommended value is -2."] = "想法弹窗字号默认跟随正文。\n可以在这里指定相对正文字号再小一点或再大一点。\n负值更小，正值更大。\n建议值为 -2。",
    ["The thought popup text is rendered in light gray shades. Increase the contrast to darken the text (the maximum renders pure black), decrease it to lighten it."] = "想法弹窗文本默认是浅灰色。增大对比度会让文字变深（最大值是纯黑），减小则会变浅。",
}
